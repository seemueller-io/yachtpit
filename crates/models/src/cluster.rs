...
use super::systems::*;
use crate::instrument_theme::instruments_theme;
use crate::instrument_theme::instruments_theme::BACKGROUND_COLOR_ACCENT;
            ...
            parent
                ...
                .with_children(|row| {
                    ...
                    row.spawn((
                        ...
                        BackgroundColor(instruments_theme::BACKGROUND_COLOR_PRIMARY),
                        BorderColor(instruments_theme::BORDER_COLOR_PRIMARY),
                        SpeedGauge,
                    ))
                        .with_children(|gauge| {
                            gauge.spawn((
                                Text::new("SPEED"),
                                TextFont {
                                    font_size: instruments_theme::FONT_SIZE_SMALL,
                                    ..default()
                                },
                                TextColor(instruments_theme::TEXT_COLOR_PRIMARY),
                            ));
                            gauge.spawn((
                                Text::new("12.5"),
                                TextFont {
                                    font_size: instruments_theme::FONT_SIZE_LARGE,
                                    ..default()
                                },
                                TextColor(instruments_theme::TEXT_COLOR_SUCCESS),
                            ));
                            gauge.spawn((
                                Text::new("KTS"),
                                TextFont {
                    ...
                    row.spawn((
                        ...
                        BackgroundColor(instruments_theme::BACKGROUND_COLOR_ACCENT),
                        BorderColor(instruments_theme::BORDER_COLOR_PRIMARY),
                        NavigationDisplay,
                    ))
                        .with_children(|nav| {
                            nav.spawn((
                                Text::new("NAVIGATION"),
                                TextFont {
                                    font_size: instruments_theme::FONT_SIZE_NORMAL,
                                    ..default()
                                },
                                TextColor(instruments_theme::TEXT_COLOR_PRIMARY),
                            ));
            ...
            parent
                ...
                .with_children(|row| {
                    ...
                    row.spawn((
                        ...
                        BackgroundColor(instruments_theme::BACKGROUND_COLOR_SECONDARY),
                        BorderColor(instruments_theme::BORDER_COLOR_SECONDARY),
                    ))
                        .with_children(|grid| {
                            grid.spawn((
                                Text::new("SYSTEMS"),
                                ...
                                TextColor(instruments_theme::TEXT_COLOR_SECONDARY),
                            ));
